...
knitr::include_graphics(here::here("img", "R-install-windows.png"))
```
...
knitr::include_graphics(here::here("img", "R-install-macos.png"))
```
...
knitr::include_graphics(here::here("img", "Rstudio-01.png"))
```
...
knitr::include_graphics(here::here("img", "Rstudio-02.png"))
```
...
knitr::include_graphics(here::here("img", "Rstudio-03.png"))
```
...
knitr::include_graphics(here::here("img", "Rstudio-04.png"))
```
...
knitr::include_graphics(here::here("img", "Rstudio-05.png"))
```
...
knitr::include_graphics(here::here("img", "Rstudio-06.png"))
```
